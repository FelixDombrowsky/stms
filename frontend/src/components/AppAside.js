        ...
        <CTabPane className="p-3" visible={activeKey === 2}>
          <div className="d-flex">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="small text-body-secondary mt-1">
                Attention team, we&#39;ll be conducting critical system maintenance tonight from 10 PM to 2 AM. Plan
                accordingly...
              </div>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="small text-body-secondary mt-1">
                Kudos on hitting sales targets last quarter! Let&#39;s keep the momentum. New goals, new victories
                ahead...
              </div>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="small text-body-secondary mt-1">
                Team, it&#39;s time for our monthly inventory check. Accurate counts ensure smooth operations. Let&#39;s
                nail it...
              </div>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="small text-body-secondary mt-1">
                Our latest customer feedback is in. Let&#39;s analyze and discuss improvements for an even better
                service...
              </div>
            </div>
          </div>
