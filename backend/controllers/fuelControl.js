...
export const getFuelTypes = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Read FuelType Error", error: err.message });
  }
};
...
export const addFuelTypes = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Post FuelType Error", error: err.message });
  }
};
...
export const getFuelNames = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Read FuelName Error", error: err.message });
  }
};
